...
function EngagementChart({ visible }: { visible: boolean }) {
  ...
  const W = 500,
    H = 160;
  const raw = [
    1600, 2800, 4200, 3400, 4600, 3200, 4000, 3600, 5000, 4200, 5400, 5800,
  ];
      ...
      <div style={{ position: "relative" }}>
        ...
        >
          ...
          {yLabels
            ...
            .reverse()}
          <path d={area} fill="url(#engGrad)" clipPath="url(#engClip)" />
          <path
            d={line}
            fill="none"
            stroke="#7c5cfc"
...
function ChannelDonut() {
  const segs = [
    { label: "Web Chat", pct: 45, color: "#7c5cfc" },
    { label: "SMS", pct: 25, color: "#818cf8" },
    { label: "Email", pct: 20, color: "#a78bfa" },
    { label: "WhatsApp", pct: 10, color: "#c4b5fd" },
  ];
  const R = 44,
    CX = 52,
    CY = 52,
...
export default function HealthcareDashboard() {
  ...
  const s2 = [32, 40, 46, 44, 54, 52, 60, 66];
  const s3 = [55, 50, 45, 52, 44, 50, 40, 46];
  const s4 = [60, 65, 70, 68, 76, 72, 78, 84];
            ...
            >
              ...
              >
                {[
                  {
                    icon: "📈",
                    title: "High Appointment Demand",
                    body: "Appointments are 28% higher than last week.",
                  },
                  {
                    icon: "💬",
                    title: "Common Inquiry",
                    body: "Billing & insurance questions increased by 32%.",
                  },
                  {
                    icon: "⚠️",
                    title: "No-Show Alert",
                    body: "No-show rate decreased by 12.6% with AI reminders.",
                  },
                ].map((ins) => (
