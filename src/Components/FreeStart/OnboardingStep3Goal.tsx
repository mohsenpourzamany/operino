  ...
  return (
    <>
      ...
      <div className="flex h-full flex-col gap-6 p-8">
        <div
          className="s3-fade flex items-center gap-2"
        ...
        <div
          className="s3-fade grid grid-cols-3 gap-3"
        ...
        >
          {goals.map((g, i) => (
            ...
            >
              ...
              <span className="text-[12px] font-semibold text-white text-center">
                {g.label}
              </span>
            </div>
          ))}
        ...
        <div
          className="s3-fade mt-auto flex items-center justify-between"
        ...
        >
          ...
          <button
            onClick={() => selected.length > 0 && onNext({ goals: selected })}
            disabled={selected.length === 0}
            className="s3-btn flex items-center gap-2 rounded-xl bg-[#7c5cfc] px-6 py-2.5 text-[13px] font-bold text-white"
          >
            Continue →
          </button>
        </div>
