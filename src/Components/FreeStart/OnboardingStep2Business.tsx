  ...
  return (
    <>
      ...
      <div className="flex h-full flex-col gap-6 p-8">
        <div
          className="s2-fade flex items-center gap-2"
        ...
        <div className="s2-fade" style={{ animationDelay: "0.1s" }}>
          ...
          <p className="mt-1 text-[13px] text-gray-400">
            This helps me customize Operino for you.
          </p>
        </div>
        <div
          className="s2-fade grid grid-cols-3 gap-3"
        ...
        <div
          className="s2-fade mt-auto flex items-center justify-between"
        ...
        >
          ...
          <button
            onClick={() => selected && onNext({ businessType: selected })}
            disabled={!selected}
            className="s2-btn flex items-center gap-2 rounded-xl bg-[#7c5cfc] px-6 py-2.5 text-[13px] font-bold text-white"
          >
            Continue →
          </button>
        </div>
